...
var generate_doubtfire_csv = function (kind, data, csv_properties) {
    var new_data = _.map(data, function (o) {
        return [answers.unitCode, o[csv_properties.email_idx], o[csv_properties.student_id_idx], o[csv_properties.first_name_idx], o[csv_properties.last_name_idx], o[csv_properties.email_idx] + '@deakin.edu.au', '']
    })
...
var generate_discourse_csv = function (data, csv_properties) {
    var new_data = _.map(data, function (o) {
        return [o[csv_properties.email_idx] + '@deakin.edu.au', answers.discourseGroup, answers.topicID]
    })
